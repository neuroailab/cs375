...
from autoencoder_shallow_bottleneck_model import ae_model_sparse, ae_loss_sparse
...
class CIFARExperiment():
    ...
    def setup_params(self):
        ...
        params['loss_params'] = {
            ...
            'loss_per_case_func': ae_loss_sparse,
        ...
        params['save_params'] = {
            ...
            'port': 24444,
            'dbname': 'assignment2',
            'collname': 'ae_shallow_bottleneck_sparse',
    ...
    def autoencoder_validation(self, inputs, outputs, n=5, **kwargs):
        ...
        '''
        return {'total_loss': ae_loss_sparse(inputs, outputs),
                'pred': outputs['deconv'],
                'gt': outputs['input']}
