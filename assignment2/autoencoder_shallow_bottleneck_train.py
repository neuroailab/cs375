...
from autoencoder_shallow_bottleneck_model import ae_model, ae_model_in, ae_loss
...
class CIFARExperiment():
    ...
    def setup_params(self):
        ...
        params['save_params'] = {
            ...
            'port': 24444,
            'dbname': 'assignment2',
            'collname': 'ae_shallow_bottleneck',
    ...
    def autoencoder_validation(self, inputs, outputs, n=5, **kwargs):
        ...
        '''
        return {'total_loss': ae_loss(inputs, outputs),
                'pred': outputs['deconv'],
                'gt': outputs['input']}
...
class ImageNetExperiment():
    ...
    def setup_params(self):
        ...
        params['save_params'] = {
            ...
            'port': 24444,
            'dbname': 'assignment2',
            'collname': 'ae_shallow_bottleneck_in',
            'exp_id': '1st_experiment',
    ...
    def autoencoder_validation(self, inputs, outputs, n=1, **kwargs):
        '''
        Validation to view the reconstructed images
        '''
        return {'total_loss': ae_loss(inputs, outputs),
