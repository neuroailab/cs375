...
class ImageNetExperiment():
    ...
    class Config():
        """
        Holds model hyperparam s and data information.
        ...
        thres_loss = 1000
        num_minibatches=0
        n_epochs = 0 #Don't actually want to train this network
        train_steps = 0#ImageNetDataProvider.N_TRAIN / batch_size * n_epochs
    ...
    def in_top_k(self, inputs, outputs):
        ...
        def k_wrapper(inputs, outputs, k):
            return tf.nn.in_top_k(outputs['pred'], outputs['labels'], k)
